...
DROP TABLE IF EXISTS `sp_gf_entry`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `sp_gf_entry` (
...
LOCK TABLES `sp_gf_entry` WRITE;
/*!40000 ALTER TABLE `sp_gf_entry` DISABLE KEYS */;
/*!40000 ALTER TABLE `sp_gf_entry` ENABLE KEYS */;
UNLOCK TABLES;
